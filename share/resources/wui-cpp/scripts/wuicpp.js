...
define("wuicpp", ["require", "exports", "axios"], function (require, exports, axios_1) {
    ...
    (function (wuicpp) {
        ...
        class Application {
            constructor() {
                this._update_callbacks = new Array();
                this._update_timer = NaN;
                this._update_timer_period_ms = 1000;
                this._grid_data = new Map();
                this._container_creators = new Array();
                this._server_ip = window.location.href.substring(0, window.location.href.length - 1); // remove trailing /
                let this_obj = this;
                jqwidgets.createInstance('#start-btn', 'jqxButton', {
                    width: '120px',
                    height: '35px',
                    theme: 'bootstrap'
                    ...
                    let loading_ui = jqwidgets.createInstance('#' + loading.id, 'jqxLoader', {
                        width: '100px',
                        height: '100px'
                    });
                    loading_ui.open(0, 0);
                    this_obj.stopUpdateTimer();
                    axios_1.default.get(this_obj._server_ip + '/get_ui', {
                        responseType: 'json'
                ...
                jqwidgets.createInstance('#stop-btn', 'jqxButton', {
                    width: '120px',
                    height: '35px',
                    theme: 'bootstrap'
                }).addEventHandler('click', function () {
                ...
                jqwidgets.createInstance('#refresh-rate', 'jqxNumberInput', {
                    width: '120px',
                    height: '35px',
                    spinButtons: true,
                    spinButtonsStep: 10,
            ...
            clearUIContainer(container_name) {
            ...
            createSlider(widget) {
                ...
                jqwidgets.createInstance('#' + slider_label.id, 'jqxInput', {
                    width: '18%',
                    height: '30%'
                });
                let this_obj = this;
                ...
                jqwidgets.createInstance('#' + slider.id, 'jqxSlider', {
                    width: '80%',
                    height: '100%',
            ...
            createRange(widget) {
                ...
                jqwidgets.createInstance('#' + range_label.id, 'jqxInput', {
                    width: '18%',
                    height: '30%'
                });
                let this_obj = this;
                ...
                jqwidgets.createInstance('#' + range.id, 'jqxRangeSelector', {
                    width: '70%',
                    height: '33%',
                    // padding: 0,
            ...
            createProgressBar(widget) {
                ...
                jqwidgets.createInstance('#' + pb_label.id, 'jqxInput', {
                    width: '18%',
                    height: '30px'
                });
                let this_obj = this;
                let pb = jqwidgets.createInstance('#' + progress_bar.id, 'jqxProgressBar', {
                    width: '80%',
                    height: '40px',
                    showText: true,
                    animationDuration: 0,
                ...
                this._update_callbacks.push(function () {
                    axios_1.default.post(this_obj._server_ip + '/get_value', {
                        id: widget.id
                    }, {
                        responseType: 'text'
                    })
            ...
            createButton(widget) {
                ...
                let this_obj = this;
                jqwidgets.createInstance('#' + button.id, 'jqxButton', {
                    width: '120px',
                    height: '35px',
                    theme: 'bootstrap'
                }).addEventHandler('click', function () {
            ...
            createSwitch(widget) {
                ...
                jqwidgets.createInstance('#' + switch_label.id, 'jqxInput', {
                    width: '180px',
                    height: '30px'
                });
                let this_obj = this;
            ...
            createTabs(widget) {
                ...
                this._container_creators.push(function () {
                    jqwidgets.createInstance('#' + tabs_container.id, 'jqxTabs');
                });
            }
            updateGrid(container_name) {
                let container = this.getUIContainer(container_name);
                let grid_id = container.id + '-' + 'table-values';
                let grid = $("#" + grid_id);
                grid.jqxGrid('updatebounddata', 'cells');
            }
            createGrid(container_name) {
                let container = this.getUIContainer(container_name);
                let grid_id = container.id + '-' + 'table-values';
                if (document.getElementById(grid_id) === null) {
                    // Create the grid when the first value is declared
                    this._grid_data[container_name] = new Array();
                    ...
                    jqwidgets.createInstance('#' + grid_id, 'jqxGrid', {
                        source: source,
        ...
        wuicpp.Application = Application;
    })(wuicpp = exports.wuicpp || (exports.wuicpp = {}));
    function createWuiApp() {
        return new wuicpp.Application();
    }
    exports.createWuiApp = createWuiApp;
});
