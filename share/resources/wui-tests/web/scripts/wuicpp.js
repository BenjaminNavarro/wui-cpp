        ...
        class Application {
            constructor() {
                ...
                jqwidgets.createInstance('#start-btn', 'jqxButton', {
                    ...
                    axios_1.default.get('http://localhost:8080/get_ui', {
                        responseType: 'json'
            ...
            createSlider(widget) {
                ...
                jqwidgets.createInstance('#' + slider.id, 'jqxSlider', {
                    ...
                    axios_1.default.post('http://localhost:8080/set_value', {
                        id: widget_name,
                        value: value
                    }, {
                        responseType: 'text'
            ...
            createLabel(widget) {
                ...
                this._update_callbacks.push(function () {
                    axios_1.default.post('http://localhost:8080/get_value', {
                        id: widget.id
                    }, {
                        responseType: 'text'
                    })
            ...
            updateGrid() {
                jqwidgets.createInstance('#wui-table-values', 'jqxGrid', {
